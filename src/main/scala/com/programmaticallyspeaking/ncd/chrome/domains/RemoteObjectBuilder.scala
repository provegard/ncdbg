...
trait RemoteObjectBuilder {
  ...
  def forSetEntry(valueRepresentation: String, objectId: String) =
    RemoteObject("object", Some("internal#entry"), Some("Object"), Some(valueRepresentation), None, None, Some(objectId))
  //        { type: 'object',
  //                subtype: 'regexp',
  //                className: 'RegExp',
  //                description: '/.*/g',
