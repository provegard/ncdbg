...
class DebuggerObjectTest extends UnitTest {
  ...
  "scriptWithPublishedFiles" - {
    ...
    "with an absolute source map URL (no leading slash)" - {
      val coffee = "->"
      val js =
        """// Generated by CoffeeScript 1.12.4
          |(function() {
          ...
          |}).call(this);
          |
          |//# sourceMappingURL=c:/path/to/file.js.map
        """.stripMargin
      implicit val reader = fakeFileReader(Map(
        coffeeFile -> coffee,
        mapFile -> map,
    ...
    "with a source map stored in another location" - {
      val coffee = "->"
      val js =
        """// Generated by CoffeeScript 1.12.4
          |(function() {
    ...
    "with a source map with a source root" - {
      val coffee = "->"
      val js =
        """// Generated by CoffeeScript 1.12.4
          |(function() {
          ...
          |//# sourceMappingURL=c:/path/to/file.js.map
        """.stripMargin
      val newMap = map.replace(""""sourceRoot": """"", """"sourceRoot": "d:/path/to/"""")
      val newCoffeeFile = new File("/d:/path/to/file.coffee")
      implicit val reader = fakeFileReader(Map(
        newCoffeeFile -> coffee,
        mapFile -> newMap,
      ...
      "publishes the coffee file based on the source root" in {
        newScript
        publisher.published should contain (newCoffeeFile)
      }
    }
